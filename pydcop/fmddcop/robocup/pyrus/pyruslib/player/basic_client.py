...
from pydcop.fmddcop.robocup.pyrus.pyruslib.network.udp_socket import IPAddress, UDPSocket
from pydcop.fmddcop.robocup.pyrus.pyruslib.player.templates import SoccerAgent
