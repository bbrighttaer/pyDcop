...
from pydcop.fmddcop.robocup.pyrus.pyruslib.rcsc.player_type import PlayerType
from pydcop.fmddcop.robocup.pyrus.pyruslib.rcsc.server_param import ServerParam as SP
from pydcop.fmddcop.robocup.pyrus.pyruslib.rcsc.types import SideID, Card


# from pydcop.fmddcop.robocup.pyrus.lib.player.templates import *
...
class PlayerObject(Object):
    ...
    def _update_more_with_full_state(self, wm):
        ...
        #         self._kickable = False
        #
        # # dist from pydcop.fmddcop.robocup.pyrus.ball
