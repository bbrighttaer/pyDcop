...
from pydcop.fmddcop.robocup.pyrus.pyruslib.action.intercept_info import InterceptInfo
...
from pydcop.fmddcop.robocup.pyrus.pyruslib.math.line_2d import Line2D
from pydcop.fmddcop.robocup.pyrus.pyruslib.math.segment_2d import Segment2D
from pydcop.fmddcop.robocup.pyrus.pyruslib.math.soccer_math import bound, frange, calc_first_term_geom_series, min_max
from pydcop.fmddcop.robocup.pyrus.pyruslib.math.vector_2d import Vector2D
from pydcop.fmddcop.robocup.pyrus.pyruslib.player.object_ball import BallObject
from pydcop.fmddcop.robocup.pyrus.pyruslib.player.object_player import PlayerObject
from pydcop.fmddcop.robocup.pyrus.pyruslib.player.stamina_model import StaminaModel
from pydcop.fmddcop.robocup.pyrus.pyruslib.player.templates import WorldModel
from pydcop.fmddcop.robocup.pyrus.pyruslib.rcsc.player_type import PlayerType
...
class SelfIntercept:
    ...
    def predict_long_step(self, max_cycle: int, save_recovery: bool, self_cache: list):
        ...
        # calc y distance from pydcop.fmddcop.robocup.pyrus.ball line
