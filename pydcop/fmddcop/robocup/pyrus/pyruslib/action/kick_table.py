...
# from pydcop.fmddcop.robocup.pyrus.typing import List
# from pydcop.fmddcop.robocup.pyrus.enum import Enum
...
from pydcop.fmddcop.robocup.pyrus.pyruslib.rcsc.game_time import *
...
class State:
    # < index of self point
    # < distance from pydcop.fmddcop.robocup.pyrus.self
    ...
    """
      ...
      \ param dist distance from pydcop.fmddcop.robocup.pyrus.self
...
"""
 ...
 \ return distance from pydcop.fmddcop.robocup.pyrus.the center of the player
"""
...
class _KickTable:
    ...
    def check_collision_after_release(self, world: WorldModel, target_point: Vector2D, first_speed):
        ...
        # check the release kick from pydcop.fmddcop.robocup.pyrus.current state
        ...
        # check the release kick from pydcop.fmddcop.robocup.pyrus.future state
