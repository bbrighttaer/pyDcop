...
from pydcop.fmddcop.robocup.pyrus.pyruslib.action.intercept_player import PlayerIntercept
from pydcop.fmddcop.robocup.pyrus.pyruslib.action.intercept_self import SelfIntercept
