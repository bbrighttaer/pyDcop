"""
  \ file hold_ball.py
  \ brief stay there and keep the ball from pydcop.fmddcop.robocup.pyrus.opponent players.
"""
import functools
...
from pydcop.fmddcop.robocup.pyrus.pyruslib.action.stop_ball import StopBall
from pydcop.fmddcop.robocup.pyrus.pyruslib.action.basic_actions import TurnToPoint
from pydcop.fmddcop.robocup.pyrus.pyruslib.player.soccer_action import BodyAction
# from pydcop.fmddcop.robocup.pyrus.lib.player.player_agent import PlayerAgent
from pydcop.fmddcop.robocup.pyrus.pyruslib.rcsc.game_time import GameTime
from pydcop.fmddcop.robocup.pyrus.pyruslib.player.templates import PlayerAgent
...
class HoldBall(BodyAction):
    """
      \ brief accessible from pydcop.fmddcop.robocup.pyrus.global.
    """
    ...
    """
      \ brief keep the ball at reverse point from pydcop.fmddcop.robocup.pyrus.the kick target point
      \ param  agent itself
    """
