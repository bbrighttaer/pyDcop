...
from pydcop.fmddcop.robocup.pyrus.pyruslib.math.triangle_2d import Triangle2D
...
class Segment2D:
    """
      ...
      \ param direction line direction from pydcop.fmddcop.robocup.pyrus.origin point
        LEN = 4
    ...
    """
      ...
      origin's coordinates value have to be different from pydcop.fmddcop.robocup.pyrus.terminal's one.
    ...
    """
      \ brief get line generated from pydcop.fmddcop.robocup.pyrus.segment
      \ return line object
    """
    ...
    """
      \ brief make perpendicular bisector line from pydcop.fmddcop.robocup.pyrus.segment points
      \ return line object
    """
    ...
    """
      \ brief calculates projection point from pydcop.fmddcop.robocup.pyrus.p
      \ param p input point
      \ return projection point from pydcop.fmddcop.robocup.pyrus.p. if it does not exist, the invalidated value vector is returned.
    """
