...
import math
from pydcop.fmddcop.robocup.pyrus.pyruslib.math.math_values import *
...
class Line2D:
    """
     ...
     \ param __c assigned c value
        2 Vec
     \ brief construct from pydcop.fmddcop.robocup.pyrus.2 points
     \ param p1 first point
     \ param p2 second point
        Vec + Ang
     \ brief construct from pydcop.fmddcop.robocup.pyrus.origin point + direction
     \ param org origin point
     \ param linedir direction from pydcop.fmddcop.robocup.pyrus.origin point
    """
    ...
    """
        Len = 2 / 2 Vector2D
      \ brief assign abc value from pydcop.fmddcop.robocup.pyrus.2 points
      \ param p1 first point
      \ param p2 second point
        Len = 2 / AngleDeg
      \ brief assign abc value t from pydcop.fmddcop.robocup.pyrus.origin point + direction
      \ param org origin point
      \ param linedir direction from pydcop.fmddcop.robocup.pyrus.origin point
    """
    ...
    """
      \ brief calculate distance from pydcop.fmddcop.robocup.pyrus.point to this line
    ...
    """
      \ brief get squared distance from pydcop.fmddcop.robocup.pyrus.this line to point
      \ param p considered point
    ...
    """
      \ brief calc projection point from pydcop.fmddcop.robocup.pyrus.p
      \ param p base point
    ...
    """
      \ brief make angle bisector line from pydcop.fmddcop.robocup.pyrus.two angles
    ...
    """
      \ brief make perpendicular bisector line from pydcop.fmddcop.robocup.pyrus.twt points
