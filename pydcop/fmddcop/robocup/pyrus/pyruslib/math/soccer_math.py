...
"""
  ...
  \ param dist distance from pydcop.fmddcop.robocup.pyrus.player to ball
  \ param dir_diff angle difference from pydcop.fmddcop.robocup.pyrus.player's body to ball
