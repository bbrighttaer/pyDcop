...
class Matrix2D:
    ...
    """
        Len = 1 / Vector2D
      \ brief create transformed vector from pydcop.fmddcop.robocup.pyrus.input vector with this matrix
      \ param v input vector
      \ return mapped vector object
        Len = 2 / XY
      \ brief create transformed vector from pydcop.fmddcop.robocup.pyrus.input coordinates with this matrix
