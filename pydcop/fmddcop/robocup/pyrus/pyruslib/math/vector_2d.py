...
class Vector2D:  # TODO maybe give some bugs because of x and _x and x()
    ...
    """
      \ brief assign XY value from pydcop.fmddcop.robocup.pyrus.POLAR value.
    ...
    """
      \ brief get the squared distance from pydcop.fmddcop.robocup.pyrus.this to 'other'.
    ...
    """
      \ brief get the distance from pydcop.fmddcop.robocup.pyrus.this to 'p'.
