...
class FMDDCOPOrchestrator(Orchestrator):
    ...
    def __init__(self, algo: AlgorithmDef,
                 ...
                 ui_port: int = None):
        super(FMDDCOPOrchestrator, self).__init__(
    ...
    def start(self):
        super(FMDDCOPOrchestrator, self).start()
        self.logger.debug('FMDDCOPOrchestrator started')


class FMDDCOPAgentsMgt(AgentsMgt):

    def __init__(self, *args, **kwargs):
        super(FMDDCOPAgentsMgt, self).__init__(*args, **kwargs)
